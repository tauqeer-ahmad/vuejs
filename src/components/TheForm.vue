<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{ invalid: enteredNameValidity === 'invalid' }">
      <label for="user-name">Your Name</label>
      <input id="user-name" name="user-name" type="text" v-model.trim="enteredName" @blur="validateInput" />
      <p v-if="enteredNameValidity === 'invalid'">Please Enter a valid name</p>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model="userAge" ref="ageData" />
    </div>
    <div class="form-control">
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log(this.$refs.ageData.value);
      console.log(24);
      this.userAge = null;
    ...
    validateInput() {
      if (this.enteredName === '') {
        this.enteredNameValidity = 'invalid';
      }
      else {
        this.enteredNameValidity = 'valid';
      }
    }
  }
}
